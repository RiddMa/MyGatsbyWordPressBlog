...
const MainLeftPanel = props => {
  return (
    ...
    <div className={"flex flex-col space-y-4 py-16"}>
      {/*<Avatar className={"avatar"}>Ridd Ma</Avatar>*/}
      <Link href={"/"} className={"title"}>
        <Typography variant={"h4"} component={"h1"} className={"href-text"} color={"primary"}>
          Ridd's Blog
        </Typography>
      </Link>
      <div className={"slogan"}>
        <Typography variant={"h6"} component={"h1"} className={"primary-text"} color={"text.primary"}>
          Think Different.
        </Typography>
      </div>
      <DarkModeToggle></DarkModeToggle>
    ...
    //   <svg className="mb-2 w-10 h-10 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="currentColor"
    ...
    //   </svg>
    //   <a href="#">
    //     <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Need a help in
    //       Claim?</h5>
    //   </a>
    //   <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">Go to this step by step guideline process on how
